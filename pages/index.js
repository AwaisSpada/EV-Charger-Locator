...
export default function Home() {
  ...
  useEffect(() => {
    if ("geolocation" in navigator) {
      ...
      navigator.geolocation.getCurrentPosition(
        ...
        (err) => {
          setError(
            "Failed to get initial location. Please ensure location services are enabled."
          );
          setLoading(false);
        },
  ...
  const recommendedStation = useMemo(() => {
    ...
    const closeStations = stationsWithDistance.filter(
      (s) => s.distance / 1000 <= 15
    );
    if (closeStations.length > 0) {
      const withAmenities = closeStations.find(
        (s) => s.amenities && s.amenities.length > 0
      );
  ...
  const stationsGreaterThan10Km = useMemo(() => {
    return stationsWithDistance.filter(
      (station) => station.distance / 1000 > 10
    );
  }, [stationsWithDistance]);
  ...
  box-sizing: border-box;
      ...
      <header
        className={`header-container${hideHeader ? " header-hidden" : ""}`}
        style={{
          ...
          width: "100%",
          zIndex: 20,
          transition: "background 0.3s, transform 0.4s cubic-bezier(.4,0,.2,1)",
        ...
        >
          <span
            style={{
              ...
              marginRight: 6,
              boxShadow: "0 1px 4px rgba(49,130,206,0.07)",
            }}
          >
            <Navigation
              size={16}
          ...
          >
            Find & track nearby EV charging stations
          </span>
          {activeStationId && (
            <span
              className="driving-mode-banner"
              style={{
                marginLeft: 18,
                padding: "3px 12px",
                background: "linear-gradient(to right, #3182ce, #0ea5e9)",
                color: "#fff",
                borderRadius: 7,
                fontWeight: 600,
                display: "inline-flex",
                ...
                gap: 5,
                fontSize: 13,
                boxShadow: "0 1px 6px rgba(14,165,233,0.18)",
        ...
        <div style={{ flex: 2, minWidth: 340, maxWidth: 700 }}>
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                background: loading
                  ? "#90cdf4"
                  : "linear-gradient(to right, #3182ce, #0284c7)",
                color: "#fff",
                border: "none",
                fontWeight: 600,
          ...
          <div
            className={`map-container ${
              mapInteractions > 0 ? "map-interaction" : ""
            }`}
            style={{
              borderRadius: 12,
              overflow: "hidden",
                  ...
                  <div
                    ...
                    style={{
                      background: isSelected
                        ? "linear-gradient(to right, #ebf8ff, #e6f6ff)"
                        : "#fff",
                  ...
                  >
                    {isRecommended && (
                      <div
                        style={{
                          ...
                          right: 12,
                          background:
                            "linear-gradient(to right, #ffb703, #fd9e02)",
                          color: "#fff",
                          fontWeight: 600,
                          fontSize: 13,
                          borderRadius: 16,
                    ...
                    >
                      ...
                      >
                        <Zap
                          size={20}
                          style={{ color: isSelected ? "#fff" : "#4a5568" }}
                        />
                      </div>
                      <div
                        style={{
                    ...
                    >
                      {station.connections !== undefined ? (
                        <>
                          <Activity size={16} />
                          <span>
                            {station.connections} charging point
                            {station.connections === 1 ? "" : "s"} available
                          </span>
                        </>
                      ) : (
                        ""
            ...
            >
              {fetchingStations ? (
                ...
                <>
                  ...
                  <div style={{ fontSize: 14, maxWidth: 240 }}>
                    Try searching for a different location or zooming out on the
                    map.
                  </div>
                </>
              )}
